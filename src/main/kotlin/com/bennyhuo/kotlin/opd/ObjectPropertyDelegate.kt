...
fun <T> delegateOf(getter: (() -> T)? = null, setter: ((T) -> Unit)? = null, defaultValue: T? = null): ReadWriteProperty<Any, T>
        = if(getter == null) ObjectPropertyDelegateNoGetter0(setter, defaultValue)  else ObjectPropertyDelegate0(getter, setter, defaultValue)
fun <T, R> delegateWithReceiverOf(receiver: R, getter: ((R) -> T)? = null, setter: ((R, T) -> Unit)? = null, defaultValue: T? = null): ReadWriteProperty<Any, T>
        = if(getter == null) ObjectPropertyDelegateNoGetter1(receiver, setter, defaultValue)  else ObjectPropertyDelegate1(receiver, getter, setter, defaultValue)
...
private class ObjectPropertyDelegateNoGetter1<T, R>(val receiver: R, val setter: ((R, T) -> Unit)? = null, defaultValue: T? = null) : ReadWriteProperty<Any, T> {
    private var value: T? = defaultValue
...
private class ObjectPropertyDelegate1<T, R>(val receiver: R, val getter: ((R) -> T), val setter: ((R, T) -> Unit)? = null, defaultValue: T? = null) : ReadWriteProperty<Any, T> {
